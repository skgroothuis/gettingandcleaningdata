...
// 
// Acceleration signals (i.e., **Acc**) from the smartphone accelerometer are in standard gravity units 'g'. Gyroscopic signals (i.e., **Gyro**) from the smartphone gyroscope are in units of radians/second.
