# Code Book: UCI-HAR-Dataset-Manipulation
...
// --------------------------------
// All acceleration signals (**Acc**) from the smartphone accelerometer are in standard gravity units 'g'.
// All gyroscopic signals (**Gyro**) from the smartphone gyroscope are the angular velocity vector with units of radians/second.
//
